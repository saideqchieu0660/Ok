...
export const VibeFlashcardActiveView: React.FC<VibeFlashcardActiveViewProps> = React.memo(({
  ...
  return (
    <div className="flex flex-col h-[100dvh] md:h-[90vh] max-w-4xl mx-auto px-4 py-4 md:py-8 font-sans animate-in fade-in duration-300">
      ...
      {!isEditing && (
        <div className="w-full max-w-xl mx-auto mt-4 sm:mt-6 shrink-0 pb-4">
          <div className="flex w-full items-center justify-between gap-3 sm:gap-4">
              ...
              <button onClick={(e) => { e.stopPropagation(); onRemindLater(); }} className="px-5 py-4 sm:py-5 bg-zinc-100 text-zinc-600 dark:bg-zinc-800 dark:text-zinc-300 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-2xl transition active:scale-95 border border-zinc-200 dark:border-zinc-700" title="Nhắc lại sau">
